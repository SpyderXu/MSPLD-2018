...
% cache name
opts.cache_name             = ['EB_Tr_', models{1}.name, '_', models{2}.name, '_', models{3}.name];
...
dataset                     = [];
dataset                     = Dataset.voc2007_trainval_eb(dataset, 'train', use_flipped);
dataset                     = Dataset.voc2007_test_eb(dataset, 'test', false);
fprintf('Done.\n');
