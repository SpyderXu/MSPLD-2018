...
%% training
    ...
    for index = 1:numel(conf.base_select)
        ...
        for idx = 1:numel(models)
            ...
            caffe.reset_all();
            caffe_test_net = caffe.Net(models{3-idx}.test_def_file, 'test');
            ...
            previous_model        = weakly_supervised([warmup_roidb_train;new_image_roidb_train], models{idx}.solver_def_file, models{idx}.net_file, opts.val_interval, opts.snapshot_interval, ...
