...
models{2}.solver_def_file   = fullfile(pwd, 'models', 'rfcn_prototxts', 'VGG16_score', 'solver_lr1_3.prototxt');
models{2}.test_net_def_file = fullfile(pwd, 'models', 'rfcn_prototxts', 'VGG16_score', 'test.prototxt');
models{2}.net_file          = fullfile(pwd, 'models', 'pre_trained_models', 'VGG16', 'vgg16.caffemodel');
models{2}.cur_net_file      = 'unset';
models{2}.name              = 'VGG16score-SIMPLE';
models{2}.mean_image        = fullfile(pwd, 'models', 'pre_trained_models', 'VGG16', 'mean_image.mat');
models{2}.conf              = rfcn_config_simple('image_means', models{1}.mean_image, ...
                                                 'classes', extra_para.VOCopts.classes, ...
...
% cache name
opts.cache_name             = ['Test_Co_', models{1}.name, '_', models{2}.name];
